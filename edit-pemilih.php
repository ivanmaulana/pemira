...
?>
          <div class="callout callout-info">
            <p>Data Pemilih Berhasil Dirubah</p>
          </div>
<?php
      }?>
          <div class="row">
                ...
                <div class="box box-info">
                  ...
                  <div class="box-body">
                    <form action="update-pemilih.php?nrp=<?php echo $id ?>" method="post">
                      ...
                      <div>
                        <input type="submit" onclick="return confirm('Anda yakin ingin mengubah data pemilih ?')" class="btn btn-primary btn-block bg-navy btn-flat" value="Simpan">
                      </div>
                    </form>
                  </div><!-- /.box-body -->
                </div><!-- /.box -->
