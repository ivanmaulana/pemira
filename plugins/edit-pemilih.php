...
<html>
  <head>
    <meta charset="UTF-8">
    <title>PEMIRA IPB | Edit Pemilih</title>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                  <li><a href="index2.html"><i class="fa fa-plus"></i> Tambah kandidat</a></li>
                  <li><a href="index2.html"><i class="fa fa-table"></i> Data kandidat</a></li>
              </ul>
            </li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                  <li><a href="index2.html"><i class="fa fa-plus active"></i> Tambah pemilih</a></li>
                 <li>
...
$p = strlen($data['email'])-15;
$email = substr($data['email'], 0, $p)
?>
              ...
              <div class="col-md-5 col-sm-6 col-xs-12">
                ...
                <div class="box box-info">
                  ...
                  <div class="box-header">
                    <h3 class="box-title" ><?php if (empty($_GET['msg'])){ echo "Edit Pemilih";} else {?> <font color="green">Data Berhasil di Ubah</font><?php ; }?></h3>
                  </div><!-- /.box-header -->

                  <div class="box-body">
                    <form action="update-pemilih.php?nrp=<?php echo $id ?>" method="post">
                      <!-- text input -->
                      <div class="form-group">
                        <label>NRP</label>
                        <input type="text" name="nrp" maxlength="9" disabled class="form-control" value="<?php echo $data['nrp']?>"/>
                      </div>
                      <div class="form-group">
                        <label>Nama Lengkap</label>
                        <input type="text" name="fullname" maxlength="40" class="form-control" value="<?php echo $data['fullname']?>"/>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="telepon" maxlength="12" value="<?php echo $data['telp']?>"/>
                      </div><!-- /.input group --><br>
                      <div>
