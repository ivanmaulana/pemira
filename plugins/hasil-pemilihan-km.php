...
<html>
  <head>
    <meta charset="UTF-8">
    <title>PEMIRA IPB | Hasil Pemilihan KM</title>
...
<?php //ambil data banyak pemilih kandidat 1 dan 2 dari seluruh ipb
      $count_K1 = mysql_query("SELECT COUNT(*) AS c FROM data WHERE KM_K1='1'");
      $count_K2 = mysql_query("SELECT COUNT(*) AS c FROM data WHERE KM_K2='1'");
      $c_k1 = mysql_fetch_array($count_K1);
      $c_k2 = mysql_fetch_array($count_K2);
?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Wilayah KM IPB</li>
          </ol>
        </section>
            ...
            <div class="col-xs-12">
              ...
              <div class="box box-solid">
                <div class="box-header">
                  <i class="fa fa-bar-chart-o"></i>
                  <h3 class="box-title">Hasil Pemilihan Wilayah KM IPB</h3>
                ...
                <div class="box-body text-center">
                  <div class="sparkline" data-type="pie" data-offset="90" data-width="200px" data-height="200px">
                    <?php echo $c_k1['c'];?> , <?php echo $c_k2['c'];?>
                  </div><br>
                  <div class="sparkline-label"><a class="text-blue" href="#"><i class="fa fa-square"></i></a></a><?php echo $k1['fullname']; ?> & <?php echo $w1['fullname']; ?></div>
                  <div class="sparkline-label"><a class="text-red" href="#"><i class="fa fa-square"></i></a></a><?php echo $k2['fullname']; ?> & <?php echo $w2['fullname']; ?></div>
                </div><!-- /.box-body -->
              </div><!-- /.box -->
            </div><!-- /.col -->
          </div><!-- /.row -->
