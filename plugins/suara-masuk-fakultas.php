                ...
                <div class="box-body">
                  <div class="row">
                    <div class="col-md-12 col-sm-24 col-xs-24 text-center">
                      <input type="text" class="knob" value="<?php echo number_format($f_persentase,2) ;?>" data-width="200" data-height="200" data-fgColor="#3c8dbc"/>
                    </div><!-- ./col -->
                  </div><!-- /.row -->
                </div><!-- /.box-body -->
              </div><!-- /.box -->
...
?>
                    <div class="col-md-6 col-sm-12 col-xs-12 text-center">
                      <input type="text" class="knob" value="<?php echo number_format($d_persentase,2);?>" data-width="200" data-height="200" data-fgColor="#3c8dbc"/>
