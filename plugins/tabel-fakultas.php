...
<html>
  <head>
    <meta charset="UTF-8">
    <title>PEMIRA IPB | Daftar Departemen</title>
  ...
  <body class="skin-blue">
    <div class="wrapper">
      ...
      <?php 
          $q_fak = mysql_query("SELECT * FROM fakultas");
          while ($data = mysql_fetch_array($q_fak)) {
      ?>
                    <tbody>
                      <tr>
                        <td><?php echo $data['nama_fakultas']; ?></td>
                        <td>
                            <a href="tabel-departemen.php?id=<?php echo $data['kode_fakultas']; ?>"><input type="button" value="Lihat Departemen"></a>
                        </td>
                      </tr>
                    </tbody>
        <?php }?>
