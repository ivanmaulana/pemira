...
<html>
  ...
  <body class="skin-blue layout-top-nav">
    ...
    ?>
      ...
      <?php 
          $q_record_pemilih = mysql_query("SELECT pengguna.nrp, pengguna.fullname, pengguna.email, data.status FROM pengguna INNER JOIN fakultas, data, departemen WHERE pengguna.fakultas=fakultas.kode_fakultas AND pengguna.departemen=departemen.kode_departemen AND data.nrp = pengguna.nrp AND pengguna.departemen='$id_dep' ORDER BY pengguna.nrp");
