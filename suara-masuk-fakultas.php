...
<html>
  <head>
    <meta charset="UTF-8">
    <title>PEMIRA IPB | Suara Masuk Fakultas</title>
...
<?php //ambil data fakultas dari id
      $f = $_GET['id'];
      $query = mysql_query("SELECT * FROM fakultas WHERE kode_fakultas='$f'");
      $fakultas = mysql_fetch_array($query);

      $count_seluruh = mysql_query("SELECT COUNT(*) AS c FROM pengguna INNER JOIN data WHERE pengguna.nrp = data.nrp AND pengguna.fakultas ='$f'");
      $count_telah_memilih = mysql_query("SELECT COUNT(*) AS c FROM pengguna INNER JOIN data WHERE pengguna.nrp = data.nrp AND pengguna.fakultas ='$f' AND data.status=1");
      $c_s = mysql_fetch_array($count_seluruh);
      $c_tm = mysql_fetch_array($count_telah_memilih);

      $f_persentase = $c_tm['c']/$c_s['c']*100;
?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-bar-chart-o"></i> Suara Masuk</a></li>
            <li class="active">Wilayah <?php echo $fakultas['singkatan'];?></li>
          </ol>
        </section>
            ...
            <div class="col-xs-12">
              ...
              <div class="box box-solid">
                <div class="box-header">
                  <i class="fa fa-bar-chart-o"></i>
                  <h3 class="box-title">Wilayah <?php echo $fakultas['singkatan'];?></h3>
                ...
                <div class="box-body">
                  <div class="row">
                    <div class="col-md-12 col-sm-24 col-xs-24 text-center">
                      <input type="text" class="knob" value="<?php echo number_format($f_persentase,2) ;?>" data-width="200" data-height="200" data-fgColor="#3c8dbc" data-readonly="true"/>
                    </div><!-- ./col -->
                  </div><!-- /.row -->
                </div><!-- /.box-body -->
              </div><!-- /.box -->
          ...
          <div class="row">
            <div class="col-xs-12">
              ...
              <div class="box box-solid">
                ...
                <div class="box-body">
                  <div class="row">
<?php     $departemen = mysql_query("SELECT * FROM departemen WHERE kode_fakultas = '$f' ORDER BY kode_fakultas");
          while ($data_dep = mysql_fetch_array($departemen)) {
                $d = $data_dep['kode_departemen'];
                $count_departemen_seluruh = mysql_query("SELECT COUNT(*) AS c FROM pengguna INNER JOIN data WHERE pengguna.nrp = data.nrp AND pengguna.fakultas ='$f' AND pengguna.departemen='$d'");
                $count_departemen_telah_memilih = mysql_query("SELECT COUNT(*) AS c FROM pengguna INNER JOIN data WHERE pengguna.nrp = data.nrp AND pengguna.fakultas ='$f' AND data.status=1 AND pengguna.departemen='$d'");
                $c_d_s = mysql_fetch_array($count_departemen_seluruh);
                $c_d_tm = mysql_fetch_array($count_departemen_telah_memilih);

                $d_persentase = $c_d_tm['c']/$c_d_s['c']*100;
?>
                    <div class="col-md-6 col-sm-12 col-xs-12 text-center">
                      <input type="text" class="knob" value="<?php echo number_format($d_persentase,2);?>" data-width="200" data-height="200" data-fgColor="#3c8dbc" data-readonly="true"/>
