...
<html>
  <head>
    <meta charset="UTF-8">
    <title>PEMIRA IPB | Suara Masuk KM</title>
...
<?php //ambil data fakultas dari id
      $count_seluruh = mysql_query("SELECT COUNT(*) AS c FROM pengguna INNER JOIN data WHERE pengguna.nrp = data.nrp");
      $count_telah_memilih = mysql_query("SELECT COUNT(*) AS c FROM pengguna INNER JOIN data WHERE pengguna.nrp = data.nrp AND data.status=1");
      $c_s = mysql_fetch_array($count_seluruh);
      $c_tm = mysql_fetch_array($count_telah_memilih);

      $persentase = $c_tm['c']/$c_s['c']*100;
?>
            ...
            <div class="col-xs-12">
              ...
              <div class="box box-solid">
                <div class="box-header">
                  <i class="fa fa-bar-chart-o"></i>
                  <h3 class="box-title">Wilayah Seluruh IPB</h3>
                ...
                <div class="box-body">
                  <div class="row">
                    <div class="col-md-12 col-sm-24 col-xs-24 text-center">
                      <input type="text" data-readonly="true" class="knob" value="<?php echo number_format($persentase,2) ;?>" data-width="200" data-height="200" data-fgColor="#3c8dbc"/>
                    </div><!-- ./col -->
                  </div><!-- /.row -->
                </div><!-- /.box-body -->
              </div><!-- /.box -->
          ...
          <div class="row">
            <div class="col-xs-12">
              ...
              <div class="box box-solid">
                <div class="box-header">
                  <i class="fa fa-bar-chart-o"></i>
                  <h3 class="box-title">Data per Wilayah</h3>
                  <div class="box-tools pull-right">
                    <button class="btn btn-default btn-sm" data-widget="collapse"><i class="fa fa-minus"></i></button>
                    <button class="btn btn-default btn-sm" data-widget="remove"><i class="fa fa-times"></i></button>
                  </div>
                ...
                <div class="box-body">
                  <div class="row">
<?php     $fakultas = mysql_query("SELECT * FROM fakultas ORDER BY kode_fakultas");
          while ($data_fak = mysql_fetch_array($fakultas)) {
                $f = $data_fak['kode_fakultas'];
                $count_fakultas_seluruh = mysql_query("SELECT COUNT(*) AS c FROM pengguna INNER JOIN data WHERE pengguna.nrp = data.nrp AND pengguna.fakultas ='$f' ");
                $count_fakultas_telah_memilih = mysql_query("SELECT COUNT(*) AS c FROM pengguna INNER JOIN data WHERE pengguna.nrp = data.nrp AND pengguna.fakultas ='$f' AND data.status=1");
                $c_f_s = mysql_fetch_array($count_fakultas_seluruh);
                $c_f_tm = mysql_fetch_array($count_fakultas_telah_memilih);

                $f_persentase = $c_f_tm['c']/$c_f_s['c']*100;
?>
                    <div class="col-md-6 col-sm-12 col-xs-12 text-center">
                      <input type="text" data-readonly="true" class="knob" value="<?php echo number_format($f_persentase,2);?>" data-width="200" data-height="200" data-fgColor="#3c8dbc"/>
                      <div class="knob-label"><?php echo $data_fak['nama_fakultas'];?></div><br>
                    </div><!-- ./col -->
<?php } ?>
                  </div><!-- /.row -->
                </div><!-- /.box-body -->
