...
?>
          <div class="callout callout-info">
            <p>Data Pemilih Berhasil dihapus</p>
          </div>
<?php
      }?>
          <div class="row">
      ...
      <?php
        ...
        $q_record_pemilih = mysql_query("SELECT * FROM pengguna INNER JOIN fakultas, departemen WHERE pengguna.fakultas=fakultas.kode_fakultas AND pengguna.departemen=departemen.kode_departemen AND pengguna.departemen='$id_dep' ORDER BY pengguna.nrp LIMIT $posisi,$batas");
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><center>
                            ...
                            <a href="delete.php?id=<?php echo $data['nrp']; ?>"><input type="button" onclick="return confirm('Anda yakin ingin menghapus data <?php echo $data['fullname']; ?> ?')" value="Hapus"></a>
                            <a   href="sendmail.php?nrp=<?php echo $data['nrp']; ?>"><input type="button" onclick="return confirm('Anda yakin ingin mengirim email kepada <?php echo $data['fullname']; ?> ?')" value="Mail"></a>
                        </center></td>
                      </tr>
                    </tbody>
        <?php }?>
            ...
            //=============PAGING ========================
                    ...
                    for($i = 1; $i <= $jumlah_halaman; $i++)
                        if($i != $halaman) {
                          echo "<a href=tabel-pemilih.php?id=$id_dep&halaman=$i> $i </a>|";
                        } else {
                            echo "<b> $i </b>|";
                        }
    ?>
