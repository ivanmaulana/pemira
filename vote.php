...
<!DOCTYPE html>
 <html>
  <head>
    ...
    <!-- Ionicons -->
<link href="bootstrap/css/vote.css" rel="stylesheet" type="text/css" />
                      ...
                      <div class="col-md-6 col-sm-12 col-xs-12 text-center">
                        ...
                        <table class="table no-margin">
                          ...
                          <tr>
                            <th><center>
      <label>
      <input type="radio" name="km" value="1" required="required"/>
      <img width="250px" height="250px" src="image/K1K.png">
      </center></th>
                          </tr>
                          <tr>
                      ...
                      <div class="col-md-6 col-sm-12 col-xs-12 text-center">
                        <table class="table no-margin">
                          ...
                          <tr>
                            <th><center>
      <label>
      <input type="radio" name="km" value="2" required="required" />
      <img width="250px" height="250px" src="image/K2K.png"></center></th>
      </label>
                          </tr>
                          <tr>
...
?>
      ...
      <label>
                          <tr>
                            <th><center>
      <label>
      <input type="radio" name="f" value="1" required="required" />
      <img width="250px" height="250px" src="image/<?php echo $f_k1['image'] ?>"></center></th>
      </label>
        </tr>
                          <tr>
                      ...
                      <div class="col-md-6 col-sm-12 col-xs-12 text-center">
                        <table class="table no-margin">
                          ...
                          <tr>
                            <th><center>
      <label>
      <input type="radio" name="f" value="2" required="required" />
      <img width="250px" height="250px" src="image/<?php echo $f_k2['image'] ?>"></center></th>
                        </label>
        </tr>
                          <tr>
          ...
          <div class="row">
            <div class="col-xs-12">
              <!-- jQuery Knob -->
                  <div class="box-body">
                    <div class="row">
                        <center><input type="submit" onclick="return confirm('Anda yakin ingin memberikan hak suara anda ?')" value="Berikan Suara" class="btn btn-primary btn-block btn-flat"></center>
                    </div>
                    </form>
                </div><!-- /.box-header -->
              </div><!-- /.box -->
